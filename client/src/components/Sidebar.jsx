...
const navItems = [
  ...
  { to: '/ai/remove-background', label: 'Remove Background', Icon: EraserIcon },
        ...
        {/* try to learn this  */}
          {navItems.map(({ to, label, Icon }) => (
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `px-3.5 py-2.5 flex items-center gap-3 rounded-lg mb-2 transition-all ${
                  isActive
